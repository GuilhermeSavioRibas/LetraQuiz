...
def admin_questions():
    ...
    conn.close()
    return render_template('admin_questions.html', questions=questions, themes=themes)
...
if __name__ == '__main__':
    ...
    # implementar gerenciamento de usuários para admins (criar, excluir, editar).
    # alterar tela de login para mobile.
